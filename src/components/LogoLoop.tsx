...
export interface ImageLogoItem {
  ...
  width?: number;
  height?: number;
  ariaLabel?: string; // Added missing property
}
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const itemAriaLabel = item.ariaLabel ?? (typeof item.title === 'string' ? item.title : undefined);
        ...
        const inner = item.href ? (
          <a
            ...
            className={cx(
              ...
              'visible:outline-current focus-visible:outline-offset-2'
            )}
            style={{
              display: 'contents'
            }}
